...
class __TwigTemplate_9e5d520fe201c0426b1bcdf1078df7fac51504da545980318857070e5ee62a3f extends \Twig\Template
{
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null))))) : (""))];
        // line 83
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->attachLibrary("claro/classy.node"), "html", null, true);
        echo "
<article";
        // line 84
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/classy/content/node.html.twig", "/Users/hamad/WebServer/zeedevelopers/core/themes/claro/templates/classy/content/node.html.twig");
    }
}
