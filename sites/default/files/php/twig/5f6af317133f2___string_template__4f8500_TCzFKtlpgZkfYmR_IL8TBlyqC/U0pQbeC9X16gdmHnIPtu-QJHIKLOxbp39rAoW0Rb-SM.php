...
/* __string_template__4f85009e52e88c4a8667666c89da6fc08665c3bd80ed1c2a3b1eeedeac0d2059 */
class __TwigTemplate_fdb8280f3c46ad2074ce38914de007865ff3da7805acd11c8538fcd587daebdf extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        function setWidget(e) {
            jQuery.post(\"/admin/config/tawk_to/set_widget\", {
                pid : e.data.pageId,
                wid : e.data.widgetId
            }, function(r) {
                if(r.success) {
        ...
        function removeWidget(e) {
            jQuery.post(\"/admin/config/tawk_to/remove_widget\", function(r) {
            if(r.success) {
                \$('#widget_already_set').hide();
        ...
        jQuery(document).ready(function() {
            ...
            jQuery('#module_form').submit(function(event) {
                \$path = \"/admin/config/tawk_to/set_options\";
                jQuery.post(\$path, {
    ...
    {
        return "__string_template__4f85009e52e88c4a8667666c89da6fc08665c3bd80ed1c2a3b1eeedeac0d2059";
    }
    ...
    {
        return new Source("", "__string_template__4f85009e52e88c4a8667666c89da6fc08665c3bd80ed1c2a3b1eeedeac0d2059", "");
    }
}
